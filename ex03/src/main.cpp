...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/17 15:14:56 by baguiar-          #+#    #+#             */
/*   Updated: 2025/03/17 15:14:58 by baguiar-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main ()
{
    ...
    // DiamondTrap constructor tests
std::cout << GREEN << "=== Testing DiamondTrap constructors ===" << RESET << std::endl;

// Testing DiamondTrap default constructor
std::cout << GREEN << "Testing DiamondTrap default constructor" << RESET << std::endl;
DiamondTrap diamond1;
std::cout << "DiamondTrap " << diamond1.getName() << " created" << std::endl;
std::cout << std::endl;

// Testing DiamondTrap constructor with name parameter
std::cout << GREEN << "Testing DiamondTrap constructor with parameter name" << RESET << std::endl;
DiamondTrap diamond2("DiamondMaster");
std::cout << "DiamondTrap " << diamond2.getName() << " created" << std::endl;
std::cout << std::endl;

// DiamondTrap copy constructor
std::cout << GREEN << "Testing DiamondTrap copy constructor" << RESET << std::endl;
DiamondTrap diamond3(diamond2);
std::cout << "DiamondTrap " << diamond3.getName() << " created from copy constructor" << std::endl;
std::cout << std::endl;

// DiamondTrap assignment operator
std::cout << GREEN << "Testing DiamondTrap assignment operator" << RESET << std::endl;
DiamondTrap diamond4;
diamond4 = diamond2;
std::cout << "DiamondTrap " << diamond4.getName() << " assigned from another DiamondTrap" << std::endl;
std::cout << std::endl;
    ...
    //DiamondTrap Attack and take damage tests
    DiamondTrap diamond5("Destroyer");
    DiamondTrap diamond6("Defender");

    std::cout << YELLOW << diamond5.getName() << " has " << diamond5.getHitPoints() << " Hit Points" << RESET << std::endl;
    std::cout << RED << diamond6.getName() << " has " << diamond6.getEnergyPoints() << " Energy Points" << RESET << std::endl;

    diamond5.attack("Defender");
    diamond6.takeDamage(30);

    std::cout << YELLOW << diamond6.getName() << " has " << diamond6.getHitPoints() << " Hit Points" << RESET << std::endl;
    std::cout << RED << diamond5.getName() << " has " << diamond5.getEnergyPoints() << " Energy Points" << RESET << std::endl;
    std::cout << std::endl;
    ...
    // DiamondTrap gets repaired
    diamond5.takeDamage(10);
    diamond5.beRepaired(5);
    diamond5.highFivesGuys();  // FragTrap specific function
    std::cout << BLUE << diamond5.getName() << " has " << diamond5.getHitPoints() << " Hit Points and " << diamond5.getEnergyPoints() << " Energy Points" << RESET << std::endl;
    std::cout << std::endl;
    ...
    // DiamondTrap whoAmI function
    std::cout << GREEN << "Testing DiamondTrap whoAmI function" << RESET << std::endl;
    diamond2.whoAmI();
    std::cout << std::endl;
...
//Edge cases
    ...
    // Testing the destruction of DiamondTrap
std::cout << GREEN << "Testing DiamondTrap destructor" << RESET << std::endl;
{
    DiamondTrap diamond7("TempTrap");
    std::cout << "Inside Block: " << diamond7.getName() << " exists." << std::endl;
}
std::cout << "Exited block. TempTrap should be destroyed above" << std::endl;
std::cout << std::endl;

// Testing dynamic memory allocation for DiamondTrap
std::cout << GREEN << "Testing DiamondTrap dynamic allocation" << RESET << std::endl;
DiamondTrap* dynamicDiamondTrap = new DiamondTrap("HeapTrap");
delete dynamicDiamondTrap;
std::cout << "HeapTrap deleted" << std::endl;
std::cout << std::endl;
